      ...
      <div class="section">
        <div class="card">
          ...
          <div style="display: flex; gap: 8px; margin-top: 12px;">
            <button style="flex: 1; padding: 12px; background: ${State.meditationType === 'open' ? 'var(--color-gold)' : 'rgba(255,255,255,0.1)'}; border: 1.5px solid ${State.meditationType === 'open' ? 'var(--color-gold)' : 'rgba(255,255,255,0.15)'}; border-radius: 8px; color: ${State.meditationType === 'open' ? '#000' : 'var(--text-light)'}; font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationType('open')">Open Awareness</button>
            <button style="flex: 1; padding: 12px; background: ${State.meditationType === 'body' ? 'var(--color-gold)' : 'rgba(255,255,255,0.1)'}; border: 1.5px solid ${State.meditationType === 'body' ? 'var(--color-gold)' : 'rgba(255,255,255,0.15)'}; border-radius: 8px; color: ${State.meditationType === 'body' ? '#000' : 'var(--text-light)'}; font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationType('body')">Body Awareness</button>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div style="display: flex; gap: 8px; margin-top: 12px;">
            <button style="flex: 1; padding: 12px; background: ${State.meditationDuration === 5 ? 'var(--color-gold)' : 'rgba(255,255,255,0.1)'}; border: 1.5px solid ${State.meditationDuration === 5 ? 'var(--color-gold)' : 'rgba(255,255,255,0.15)'}; border-radius: 8px; color: ${State.meditationDuration === 5 ? '#000' : 'var(--text-light)'}; font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationDuration(5)">5</button>
            <button style="flex: 1; padding: 12px; background: ${State.meditationDuration === 10 ? 'var(--color-gold)' : 'rgba(255,255,255,0.1)'}; border: 1.5px solid ${State.meditationDuration === 10 ? 'var(--color-gold)' : 'rgba(255,255,255,0.15)'}; border-radius: 8px; color: ${State.meditationDuration === 10 ? '#000' : 'var(--text-light)'}; font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationDuration(10)">10</button>
            <button style="flex: 1; padding: 12px; background: ${State.meditationDuration === 15 ? 'var(--color-gold)' : 'rgba(255,255,255,0.1)'}; border: 1.5px solid ${State.meditationDuration === 15 ? 'var(--color-gold)' : 'rgba(255,255,255,0.15)'}; border-radius: 8px; color: ${State.meditationDuration === 15 ? '#000' : 'var(--text-light)'}; font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationDuration(15)">15</button>
            ...
            ` : `
              <button style="flex: 1; padding: 12px; background: rgba(255,255,255,0.1); border: 1.5px solid rgba(255,255,255,0.15); border-radius: 8px; color: var(--text-light); font-weight: 600; cursor: pointer; transition: all 0.2s;" onclick="Actions.setMeditationDuration('custom')">Custom</button>
            `}
          </div>
        </div>
